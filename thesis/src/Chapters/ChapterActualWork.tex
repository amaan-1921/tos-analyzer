...
\paragraph*{Figure: Retrieval Mechanism}
\begin{figure}[h]
  \begin{center}
...
\paragraph*{Figure: Frontend Architecture}
\begin{figure}[h]
  \begin{center}
...
\paragraph*{Figure: Document Analysis}
\begin{figure}[H]
  \begin{center}
...
\paragraph*{Figure: Knowledge Graph Generation}
\begin{figure}[H]
  \begin{center}
